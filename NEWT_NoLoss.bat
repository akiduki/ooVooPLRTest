...
newtman /t 480 /e "Test" BW512kbps_NoPL.xml 2> BW512kbps_NoPL.log

echo "No Loss for 1.5Mbps for 300 sec"
newtman /e "Test" /f "Test" /t 300 BW1.5Mbps_NoPL.xml 2> BW1.5Mbps_NoPL.log

echo "No Loss for 3Mbps for 450 sec"
newtman /e "Test" /f "Test" /t 450 BW3Mbps_NoPL.xml 2> BW3Mbps_NoPL.log

echo "No Loss for 1.5Mbps for 300 sec"
newtman /e "Test" /f "Test" /t 300 BW1.5Mbps_NoPL.xml 2> BW1.5Mbps_NoPLDown.log

echo "No Loss for 512kbps BW for 300 sec"
newtman /t 300 /e "Test" BW512kbps_NoPL.xml 2> BW512kbps_NoPLDown.log
