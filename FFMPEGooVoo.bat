...
del captured.mp4
ffmpeg.exe -t 1500 -f dshow -i video="UScreenCapture" -r 25 -vcodec libx264 -tune zerolatency -b 4000k -pix_fmt yuv420p -rtbufsize 200MB captured.mp4 2> ffmpegCap.log
REM All done!