...
newtman /t 420 /e "Test" BW1.5Mbps_BL1.xml
echo "Burst Loss 1% for 300 sec"

newtman /e "Test" /f "Test" /t 300 BW1.5Mbps_BL3.xml
echo "Burst Loss 3% for 300 sec"

newtman /e "Test" /f "Test" /t 300 BW1.5Mbps_BL5.xml
echo "Burst Loss 300% for 300 sec"

newtman /e "Test" /f "Test" /t 450 BW1.5Mbps_BL10.xml
...
newtman /e "Test" /f "Test" /t 300 BW1.5Mbps_BL1.xml
echo "Burst Loss 1% for 300 sec"
