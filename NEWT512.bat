...
newtman /t 420 /e "Test" BW512kbps_BL1.xml
echo "Burst Loss 1% for 300 sec"

newtman /e "Test" /f "Test" /t 300 BW512kbps_BL3.xml
echo "Burst Loss 3% for 300 sec"

newtman /e "Test" /f "Test" /t 300 BW512kbps_BL5.xml
echo "Burst Loss 5% for 300 sec"

newtman /e "Test" /f "Test" /t 450 BW512kbps_BL10.xml
...
newtman /e "Test" /f "Test" /t 300 BW512kbps_BL1.xml
echo "Burst Loss 1% for 300 sec"
